...
function colorLevelBtns() {
    ...
    switch (gCurrLevel.size) {
        case 4:
            document.querySelector('#btn-easy').style['background-color'] = 'rgb(0, 255, 76)';
            break;
        case 6:
            document.querySelector('#btn-medium').style['background-color'] = 'rgb(0, 255, 76)';
            break;
        case 8:
            document.querySelector('#btn-hard').style['background-color'] = 'rgb(0, 255, 76)';
            break;

        default:
            document.querySelector('#btn-custom').style['background-color'] = 'rgb(0, 255, 76)';
    }
}
...
function getCellPos(elCell) {
    var i = +elCell.classList[0].charAt(5);
    var j = +elCell.classList[0].charAt(7);
    return { i, j };
}
